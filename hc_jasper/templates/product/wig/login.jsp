        ...
        <fieldset>
            ...
            <c:if test="${jsEdition != 'community'}">
                <label class="control input text hidden" accesskey="o" for="orgId">
                    ...
                    <input id="orgId" name="orgId" type="text" autocapitalize="off" autocomplete="off"/>
            ...
            <label class="control input text" for="j_username">
                ...
                <input id="j_username" name="j_username" type="text" autocapitalize="off" autofocus="autofocus" autocomplete="off"/>
                <span class="message warning">error message here</span>
            </label>
            <label class="control input password" for="j_password">
                ...
                <input class="" id="j_password_pseudo" name="j_password_pseudo" type="password" maxlength="47" autocomplete="off"/>
                <input class="" id="j_password" name="j_password" type="hidden" autocomplete="off"/>
                <span class="message warning">error message here</span>
            </label>
        </fieldset>
        <fieldset>
